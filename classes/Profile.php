...
class Profile extends Managed_DataObject
{
    ...
    public static function schemaDef()
    {
        $def = array(
            ...
            'fields' => array(
                ...
                'gender'=> array('type' => 'int', 'description' => '0: undefine 1:male:2 female'),
    ...
    function setOriginalAvatarUrl($profile_image_url)
    {
        $filename = "$this->id";
        $avatar = new Avatar();
        $avatar->profile_id = $this->id;
        $avatar->width = AVATAR_STREAM_SIZE; //must be set to 48 because it only used for timeline
        $avatar->height = AVATAR_STREAM_SIZE;
