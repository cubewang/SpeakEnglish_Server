...
class CommentToUserNoticeStream extends ScopingNoticeStream
{   
    function __construct($userId, $profile=-1)
    {
        ...
        //TODO: add cache
        parent::__construct(new RawCommentToUserNoticeStream($userId));
...
class RawCommentToUserNoticeStream extends NoticeStream
{
    protected $userId;
