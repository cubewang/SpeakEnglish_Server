...
class MediaFile
{
    ...
    function __construct($user = null, $filename = null, $mimetype = null, $link = null)
    {
        if ($user == null) {
    ...
    static function fromLink($link, $user = null)
    {
        if (empty($user)) {
        ...
        return new MediaFile($user, $filename, $mimetype, $link);
    }
