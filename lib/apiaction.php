...
class ApiAction extends Action
{
    ...
    function twitterUserArray($profile, $get_notice=false)
    {
        ...
        {
            $twitter_user['gender'] = 'n';
        }
        else if ($profile->gender == 1)
        {
            $twitter_user['gender'] = 'f';
        }
        else if ($profile->gender == 2)
        {
            $twitter_user['gender'] = 'm';
        }
        else
        {
            $twitter_user['gender'] = 'n';
    ...
    function twitterSimpleStatusArray($notice, $include_user=true)
    {
        ...
        $twitter_status['reposts_count'] 	= Notice::getReposts_count($notice->id);
        $twitter_status['comments_count'] 	= Notice::getCommentCount($notice->id);
        $twitter_status['favorites_count'] 	= Notice::getFavesCount($notice->id);
    ...
    function showFullJsonObjects($objects)
    {
